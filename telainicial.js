      ...
      <View style={styles.Div_Baixa}>
        ...
        <View style={styles.Bottao}>
          <View style={styles.Dentro_Bottao}>
            <Image style={styles.logo2}source={require('../assets/estrela.png')}/>
          </View>
        </View>
        <View style={styles.Bottao}>
          <View style={styles.Dentro_Bottao}>
            <Image style={styles.logo2} source={require('../assets/ponto.png')}/>
        </View >
          </View>
        <View style={styles.Bottao}>
          <View style={styles.Dentro_Bottao}>
        ...
        <View style={styles.Bottao}>
          <View style={styles.Dentro_Bottao} import ={'./Components/abaixoAssTela1'}>
            <Image style={styles.logo2} source={require('../assets/data.png')}/>
          </View>
        </View>
      </View>
    </View>
